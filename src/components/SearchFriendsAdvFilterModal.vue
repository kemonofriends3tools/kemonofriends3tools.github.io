  ...
  <span>
    ...
    <b-modal id="modal-advFilter" title="特殊検索" title-tag="h4" size="xl">
      <b-container fluid>
        ...
        <b-button
          @click="advFilterSelected('ひやひや', ['とくせい詳細', 'キセキとくせい詳細'], 'ひやひや')"
        >
          テスト用(ひやひや)
        </b-button>
        ...
        <b-card class="mb-2" title="地形/時間特効" sub-title="特定の地形に特効をもつフレンズ">
          <b-card-text>
            <b-button>みずべ</b-button>
            <b-button>寒冷地</b-button>
            <b-button>サバンナ</b-button>
            <b-button>さばく</b-button>
            <b-button>夜</b-button>
          </b-card-text>
        </b-card>
        <b-card class="mb-2" title="地形/時間特効" sub-title="特定の地形に特効をもつフレンズ">
        ...
        <b-card class="mb-2" title="最大けも級">
          <b-card-text>
            <b-button>5</b-button>
            <b-button>6</b-button>
          </b-card-text>
        </b-card>
        <b-card class="mb-2" title="最大フォトポケ数">
          <b-card-text>
            <b-button>8</b-button>
            <b-button>12</b-button>
          </b-card-text>
        </b-card>
        <b-card class="mb-2" title="最大野生解放数">
          <b-card-text>
            <b-button>4</b-button>
            <b-button>5</b-button>
          </b-card-text>
