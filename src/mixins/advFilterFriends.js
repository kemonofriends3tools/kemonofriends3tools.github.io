  ...
  },
  {
    ...
    dataList: [
      ...
      },
      {
        ...
        labelShort: 'ちぐはぐリズム',
        regex:
          '((ちぐはぐリズム.*状態にならない|状態異常にならない)|(ちぐはぐリズム.*|全ての状態異常)耐性.*が増加|(ちぐはぐリズム.*状態|状態異常)を解除)',
      },
      {
        labelFull: '対・状態異常(ばてばてヒリヒリ)',
        labelShort: 'ばてばてヒリヒリ',
        regex:
          '((ばてばてヒリヒリ.*状態にならない|状態異常にならない)|(ばてばてヒリヒリ.*|全ての状態異常)耐性.*が増加|(ばてばてヒリヒリ.*状態|状態異常)を解除)',
      },
      {
        labelFull: '対・状態異常(ロストフラッグ)',
        labelShort: 'ロストフラッグ',
        regex:
          '((ロストフラッグ.*状態にならない|状態異常にならない)|(ロストフラッグ.*|全ての状態異常)耐性.*が増加|(ロストフラッグ.*状態|状態異常)を解除)',
      },
    ],
  },
  {
