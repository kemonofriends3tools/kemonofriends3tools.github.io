            ...
            <b-row>
              <b-col cols="12">
                <b-collapse id="collapse2">
                  <b-alert show variant="info" class="small mb-1">
                    ２：下の表の表示列を切り替えます。<br />
                    表示列を切り替えるだけなので、ここを触ってもデータ行数が変化することはありません。ただしここの選択は３の『表内全文検索』と深く関係しています。３の『表内全文検索』はここで表示させたものが検索対象となります。
                  </b-alert>
                </b-collapse>
                ...
                <b-collapse id="collapse3">
                  <b-alert show variant="info" class="small mb-1">
                    ...
                    注意してほしいのは検索対象は<span class="font-weight-bold"
                      >現在表に表示されている文字列</span
                    >だという点です。例えばとくせいに”くらくら耐性”を持つフォトがあったとしても、２で”とくせい”関係の列を表示させていないとHITしません。
                  </b-alert>
                </b-collapse>
              </b-col>
            </b-row>
